...
struct utest_type_deducer<unsigned short, false> {
  static void _(const unsigned short s) { UTEST_PRINTF("%u", static_cast<int>(s)); }
};
...
struct utest_type_deducer<const T *, false> {
  static void _(const T *t) { UTEST_PRINTF("%p", static_cast<void *>(const_cast<T *>(t))); }
};
...
UTEST_WEAK UTEST_OVERLOADABLE void utest_type_printer(signed char c) { UTEST_PRINTF("%d", UTEST_CAST(int, c)); }
...
UTEST_WEAK UTEST_OVERLOADABLE void utest_type_printer(float f) { UTEST_PRINTF("%f", UTEST_CAST(double, f)); }

UTEST_WEAK UTEST_OVERLOADABLE void utest_type_printer(double d);

UTEST_WEAK UTEST_OVERLOADABLE void utest_type_printer(double d) { UTEST_PRINTF("%f", d); }
...
UTEST_WEAK UTEST_OVERLOADABLE void utest_type_printer(int i) { UTEST_PRINTF("%d", i); }

UTEST_WEAK UTEST_OVERLOADABLE void utest_type_printer(unsigned int i);

UTEST_WEAK UTEST_OVERLOADABLE void utest_type_printer(unsigned int i) { UTEST_PRINTF("%u", i); }

UTEST_WEAK UTEST_OVERLOADABLE void utest_type_printer(long int i);

UTEST_WEAK UTEST_OVERLOADABLE void utest_type_printer(long int i) { UTEST_PRINTF("%ld", i); }

UTEST_WEAK UTEST_OVERLOADABLE void utest_type_printer(long unsigned int i);

UTEST_WEAK UTEST_OVERLOADABLE void utest_type_printer(long unsigned int i) { UTEST_PRINTF("%lu", i); }

UTEST_WEAK UTEST_OVERLOADABLE void utest_type_printer(const void *p);

UTEST_WEAK UTEST_OVERLOADABLE void utest_type_printer(const void *p) { UTEST_PRINTF("%p", p); }
...
UTEST_WEAK UTEST_OVERLOADABLE void utest_type_printer(long long int i) { UTEST_PRINTF("%lld", i); }

UTEST_WEAK UTEST_OVERLOADABLE void utest_type_printer(long long unsigned int i);

UTEST_WEAK UTEST_OVERLOADABLE void utest_type_printer(long long unsigned int i) { UTEST_PRINTF("%llu", i); }
...
#define UTEST(SET, NAME)                                                                                                  \
  ...
  UTEST_INITIALIZER(utest_register_##SET##_##NAME) {                                                                      \
    ...
    utest_state.tests      = UTEST_PTR_CAST(struct utest_test_state_s *,                                                  \
...
int utest_main(int argc, const char *const argv[]) {
  ...
  if (!use_colours) {
    for (index = 0; index < sizeof colours / sizeof colours[0]; index++) { colours[index] = ""; }
  }
  ...
  for (index = 0; index < utest_state.tests_length; index++) {
    ...
    if (utest_state.output) { fprintf(utest_state.output, "<testcase name=\"%s\">", utest_state.tests[index].name); }
    ...
    if (UTEST_TEST_FAILURE == result) {
      ...
      failed_testcases                   = UTEST_PTR_CAST(
        size_t *, utest_realloc(UTEST_PTR_CAST(void *, failed_testcases), sizeof(size_t) * failed_testcases_length));
      ...
      skipped_testcases                   = UTEST_PTR_CAST(
        size_t *, utest_realloc(UTEST_PTR_CAST(void *, skipped_testcases), sizeof(size_t) * skipped_testcases_length));
      if (UTEST_NULL != skipped_testcases) { skipped_testcases[skipped_testcase_index] = index; }
      skipped++;
    }
...
#define UTEST_MAIN() \
  UTEST_STATE();     \
  int main(int argc, const char *const argv[]) { return utest_main(argc, argv); }
